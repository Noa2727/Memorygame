package com.example.noanaider.my_memory_game;

/**
 * Created by noanaider on 4.4.2018.
 */
...
public class MainActivity extends AppCompatActivity {
    ...
    int turn = 1;
    int playerPoints = 0, partnerPoints = 0;
    ...
    private void change(ImageView iv, int card){
        ...
        private void calculate(){
            if (firstCard == secondCard) {
                ...
                if (turn == 1) {
                    ...
                    partnerPoints++;
                    tv_p2.setText( "p2: " + partnerPoints );
                }
            }else{
        ...
        image104 = R.drawable.elf;
        image105 = R.drawable.human;
        image106 = R.drawable.ping;
        image201 = R.drawable.bird;
        image202 = R.drawable.cat;
        image203 = R.drawable.duck;
        image204 = R.drawable.elf;
        image205 = R.drawable.human;
        image206 = R.drawable.ping;
